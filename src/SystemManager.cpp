...
FileManager *fm = GlobalFileHandler::instance()->fileManager;
BufPageManager *bpm = GlobalFileHandler::instance()->bufPageManager;
...
int SystemManager::createIndex(string relName, Attribute attrName, string idxName) {
	...
	case T_INT:
		...
		break;
	case T_FLOAT:
		attrTypes.push_back(NUMERIC);
		break;
	case T_STRING:
		attrTypes.push_back(T_CHAR);
		break;
	case T_DATE:
		attrTypes.push_back(DATE);
		break;
	case T_NONE:
		break;
	default:
